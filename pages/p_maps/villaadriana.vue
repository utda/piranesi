<template>
  <v-container class="my-5">
    ...
    <h2 class="my-5">Villa Adriana <i>Villa Hadriana</i></h2>

    <div class="text-center">
      <img
        :src="baseUrl + '/img/p_maps/img/vh.jpg'"
        alt="UrbsRoma"
        width="431"
        height="435"
        border="0"
    ...
    <map name="Map">
      <area
        shape="poly"
        coords="176,272,223,361,254,345,205,257"
        :href="getUrl(601)"
      />
      <area shape="poly" coords="168,262,128,294,156,311" :href="getUrl(602)" />
      <area shape="poly" coords="246,223,271,261,283,236" :href="getUrl(603)" />
      <area
        shape="poly"
        coords="260,174,273,183,266,200,253,190"
        :href="getUrl(604)"
      />
      <area
        shape="poly"
        coords="268,134,294,138,279,174,261,167"
        :href="getUrl(605)"
      />
      <area shape="circle" coords="363,101,19" :href="getUrl(606)" />
      <area shape="rect" coords="379,4,400,41" :href="getUrl(607)" />
      <area shape="rect" coords="137,121,163,153" :href="getUrl(608)" />
      <area shape="poly" coords="67,198,92,195,90,253" :href="getUrl(609)" />
    </map>
...
export default class Page extends Vue {
  ...
  ids = ["http://dbpedia.org/resource/Hadrian's_Villa"]
