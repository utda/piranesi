<template>
  <v-container class="my-5">
    ...
    <h2 class="my-5">Pesto <i>Paestum</i></h2>

    <div class="text-center">
      <img
        :src="baseUrl + '/img/p_maps/img/pesto.jpg'"
        alt="UrbsRoma"
        width="640"
        height="181"
        border="0"
    ...
    <map name="Map">
      <area shape="rect" coords="510,79,548,132" :href="getUrl(301)" />
      <area shape="rect" coords="452,75,492,131" :href="getUrl(302)" />
      <area shape="rect" coords="18,54,52,94" :href="getUrl(303)" />
    </map>
...
export default class Page extends Vue {
  ...
  ids = ['http://dbpedia.org/resource/Paestum']
