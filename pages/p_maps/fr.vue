<template>
  <v-container class="my-5">
    ...
    <h2 class="my-5">Rome map - <i>Foro Romano</i></h2>

    <div class="text-center">
      <img
        :src="baseUrl + '/img/p_maps/img/fr.jpg'"
        alt="UrbsRoma"
        width="594"
        height="356"
        border="0"
    ...
    <map name="Map">
      <area shape="rect" coords="332,70,377,119" :href="getUrl(10)" />
      <area shape="rect" coords="520,43,562,101" :href="getUrl(9)" />
      <area shape="rect" coords="446,144,481,178" :href="getUrl(8)" />
      <area shape="rect" coords="227,155,264,187" :href="getUrl(13)" />
      <area shape="rect" coords="91,226,124,263" :href="getUrl(11)" />
      <area shape="rect" coords="194,247,227,291" :href="getUrl(12)" />
      <area shape="rect" coords="31,217,75,248" :href="getUrl(14)" />
      <area shape="rect" coords="13,269,46,302" :href="getUrl(15)" />
      <area shape="rect" coords="54,292,85,325" :href="getUrl(16)" />
    </map>
...
export default class Page extends Vue {
  ...
  ids = ['http://dbpedia.org/resource/Roman_Forum']
