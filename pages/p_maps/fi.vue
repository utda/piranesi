<template>
  <v-container class="my-5">
    ...
    <h2 class="my-5">Rome map - <i>Fori Imperiali</i></h2>

    <div class="text-center">
      <img
        :src="baseUrl + '/img/p_maps/img/fi.jpg'"
        alt="UrbsRoma"
        width="600"
        height="313"
        border="0"
    ...
    <map name="Map">
      <area shape="rect" coords="168,121,238,165" :href="getUrl(19)" />
      <area shape="rect" coords="378,174,427,234" :href="getUrl(18)" />
      <area shape="rect" coords="496,231,536,283" :href="getUrl(17)" />
      <area shape="rect" coords="9,224,40,278" :href="getUrl(20)" />
    </map>
...
export default class Page extends Vue {
  ...
  ids = ['http://dbpedia.org/resource/Imperial_fora']
